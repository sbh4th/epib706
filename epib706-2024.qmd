...
w1c1 <- as.Date("2024-01-05")
w1c2 <- as.Date("2024-01-10")
...
```
[[PDF version]](https://samharper.org/epib706/epib706-2024.pdf)  

| **About me**                           | **About class**                                                                      |
|-----------------------------------------|-------------------------------|
| sam.harper\@mcgill.ca                  | [mycourses2.mcgill.ca/d2l/home/699913](https://mycourses2.mcgill.ca/d2l/home/699913) |
| Hours: by appointment                  | Hours: Wednesday/Friday 1005h-1125h                                                  |
...
#### What:
-   Davey Smith G. Post--Modern Epidemiology: When Methods Meet Matter. *Am J Epidemiol* 2019;188(8):1410--1419. [\[link\]](https://doi.org/10.1093/aje/kwz064) \[8601 words\]
...
### `r classdate(w1c1,9)`: Can bias analysis be biased?
...
### `r classdate(w1c1,13)`: No class [Good Friday]

### `r classdate(w1c2,13)`: Does meta-analysis help or hurt?
...
### `r classdate(w1c1,14)`: How should we discuss epidemiologic results?
...
### `r classdate(w1c2,14)`: How much does "evidence" even matter?
...
### `r classdate(w1c1,15)`: Wrap up / Can we change scientific culture? 
